  ...
  return (
    <div className={`fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 transition-opacity duration-200 ${isClosing ? 'opacity-0' : 'opacity-100'}`}>
      <div className={`bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden transform transition-all duration-200 ${isClosing ? 'scale-95 translate-y-4' : 'scale-100 translate-y-0'} animate-in fade-in zoom-in-95 slide-in-from-bottom-4`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3 bg-emerald-50 dark:bg-emerald-900/20 p-4 rounded-xl border border-emerald-100 dark:border-emerald-800/50">
                 ...
                 <input 
                    ...
                    className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-emerald-200 dark:border-emerald-700 rounded-lg text-sm focus:ring-2 focus:ring-emerald-500 outline-none transition-all shadow-inner font-mono text-slate-800 dark:text-slate-200" 
                 />
                 <input 
                    type="password"
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                ...
                <label className={`flex items-center space-x-3 cursor-pointer p-3 rounded-xl border transition-all duration-200 ${mode === 'builtin' ? 'border-amber-500 bg-amber-50/50 dark:bg-amber-900/20 shadow-sm' : 'border-transparent hover:bg-white dark:hover:bg-slate-700/50'}`}>
                ...
                <label className={`flex items-start space-x-3 cursor-pointer p-4 rounded-xl border transition-all duration-200 ${mode === 'custom' ? 'border-amber-500 bg-amber-50/50 dark:bg-amber-900/20 shadow-sm' : 'border-transparent hover:bg-white dark:hover:bg-slate-700/50'}`}>
        ...
        <div className="p-6 border-t dark:border-slate-700 flex justify-end space-x-3 bg-slate-50 dark:bg-slate-800/50 rounded-b-2xl shrink-0">
